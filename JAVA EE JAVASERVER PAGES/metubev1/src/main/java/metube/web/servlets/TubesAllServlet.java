...
import metube.domain.models.view.AllTubeViewModel;
...
public class TubesAllServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.setAttribute("allTubes", this.tubeService.findAll().stream()
                .map(t-> this.modelMapper.map(t, AllTubeViewModel.class))
